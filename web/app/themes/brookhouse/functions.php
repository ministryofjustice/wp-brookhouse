...
function hillsborough_scripts() {
  ...
  wp_register_style('brookhouse-jquery-ui', get_template_directory_uri() . '/css/jquery-ui.css');

  wp_enqueue_style('brookhouse-style', get_stylesheet_uri()); // Default underscores stylesheet
  wp_enqueue_style('brookhouse-style-custom', get_template_directory_uri() . '/css/custom.css'); // Custom stylesheet

  wp_enqueue_script('brookhouse-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true);

  wp_enqueue_script('brookhouse-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true);
  ...
  if (is_page('hearings')) {
    ...
    wp_enqueue_style('brookhouse-jquery-ui');
  }
...
function enqueue_admin_stylesheets() {
  wp_register_style('brookhouse-admin-style', get_template_directory_uri() . '/css/custom-admin.css');
...
function ajax_load_scripts() {
  ...
  wp_enqueue_script("brookhouse-ajax", get_template_directory_uri() . '/js/evidence-sort.js', array('jquery', 'jquery-ui-core', 'jquery-ui-sortable'));

  // make the ajaxurl var available to the above script
  wp_localize_script('brookhouse-ajax', 'custom_sort', array('ajaxurl' => admin_url('admin-ajax.php')));
}
