...
function hillsborough_witness_tax_add_meta() {
    ...
    <div class="form-field">
        ...
        <p class="description"><?php _e('By default the witness is listed under the first letter of their surname, but this can be overridden here by supplying an alternative letter.', 'brookhouse'); ?></p>
    </div>
    <?php
}
